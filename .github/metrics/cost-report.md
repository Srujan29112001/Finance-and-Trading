...
| Metric | Value |
|--------|-------|
| Total Minutes Used | 96.0 min |
| Free Tier Used | 96.0 min |
| Billable Minutes | 0.0 min |
| **Estimated Monthly Cost** | **$0.77** |
| Avg Minutes/Day | 3.2 min |

## Cost by Workflow

| Workflow | Runs | Minutes | Est. Cost |
|----------|------|---------|-----------|
| Pipeline Monitoring & Metrics | 121 | 81.9 | $0.65 |
...
🟢 **Well within free tier** - 4.8% used
